# Parallelising Data Processing with Spark on Google Cloud

This repository contains the work focusing on parallelisation, cloud performance evaluation, and using Spark and TensorFlow/Keras for data processing and machine learning.
...
- **Outcome**: Parallelised preprocessing to improve processing speed and scalability.

### 2. Measuring Cloud Performance
- **Task**: Parallelise the measurement of reading speeds in cloud configurations using Spark.
...
- **Apache Spark**: For parallelising data processing tasks.
